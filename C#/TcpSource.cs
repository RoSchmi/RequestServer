...
namespace ArkeIndustries.RequestServer {
    public class TcpSource : MessageSource {
        ...
        private class TcpConnection : Connection {
            ...
            protected override async Task<long> Receive(byte[] buffer, long offset, long count, bool isEndOfMessage) => await this.networkStream.ReadAsync(buffer, (int)offset, (int)count);
