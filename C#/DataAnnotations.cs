...
namespace ArkeIndustries.RequestServer {
    ...
    public abstract class BasicValidationAttribute : ValidationAttribute {
        public override long IsValid(object value, MessageContext context) => this.IsBasicValid(value) ? ResponseCode.Success : ResponseCode.ParameterValidationFailed;
    ...
    public sealed class ObjectIdAttribute : BasicValidationAttribute {
        ...
        public ObjectIdAttribute(bool optional) => this.Optional = optional;

        protected override bool IsBasicValid(object value) => this.Optional ? (long)value >= 0 : (long)value > 0;
    }
    ...
    public sealed class InEnumAttribute : BasicValidationAttribute {
        ...
        public InEnumAttribute() => this.EnumType = null;

        public InEnumAttribute(Type enumType) => this.EnumType = enumType;
